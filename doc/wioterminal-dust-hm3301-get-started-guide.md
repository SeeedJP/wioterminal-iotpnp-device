...
Connect Dust Sensor (HM3301) for Wio Terminal device to your Azure IoT services
===
...
This document describes how to connect Dust Sensor (HM3301) for Wio Terminal to Azure IoT Hub using the Azure IoT Explorer with certified device application and device models.
...
The Dust Sensor (HM3301) for Wio Terminal is a device that periodically sends the PM concentrations and the number of particles of the environment to Azure IoT.

<img src="media/6-1.jpg" height="250"/>
<img src="media/6-2.png" height="250"/>
...
|Grove - Laser PM2.5 Dust Sensor - Arduino Compatible - HM3301|101020613|1|[here](http://wiki.seeedstudio.com/Grove-Laser_PM2.5_Sensor-HM3301/)|[here](https://www.seeedstudio.com/Grove-Laser-PM2-5-Sensor-HM3301.html)|
...
Connect the Grove - Laser PM2.5 Dust Sensor - Arduino Compatible - HM3301 to the Wio Terminal with the Grove cable.
The connection to the Wio Terminal is the left side Grove connector.

<img src="media/6-3.jpg" width="400"/>
...
1. Download the latest firmware **wioterminal-dust-hm3301.uf2** from [the release page](https://github.com/SeeedJP/wioterminal-iotpnp-device/releases)
...
5. Copy **wioterminal-dust-hm3301.uf2** to the **Arduino** drive
